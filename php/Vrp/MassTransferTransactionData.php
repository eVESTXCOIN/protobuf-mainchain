...
/**
 * Generated from protobuf message <code>vrp.MassTransferTransactionData</code>
 */
class MassTransferTransactionData extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Vrp\MassTransferTransactionData\Transfer::class);
        $this->transfers = $arr;
