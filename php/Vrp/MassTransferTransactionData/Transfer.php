...
namespace Vrp\MassTransferTransactionData;
...
/**
 * Generated from protobuf message <code>vrp.MassTransferTransactionData.Transfer</code>
 */
...
class_alias(Transfer::class, \Vrp\MassTransferTransactionData_Transfer::class);
