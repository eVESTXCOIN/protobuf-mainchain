...
namespace VRP {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      reissues_.WriteTo(ref output, _repeated_reissues_codec);
      burns_.WriteTo(ref output, _repeated_burns_codec);
      if (errorMessage_ != null) {
        output.WriteRawTag(50);
        output.WriteMessage(ErrorMessage);
      }
      sponsorFees_.WriteTo(ref output, _repeated_sponsorFees_codec);
      leases_.WriteTo(ref output, _repeated_leases_codec);
      leaseCancels_.WriteTo(ref output, _repeated_leaseCancels_codec);
      invokes_.WriteTo(ref output, _repeated_invokes_codec);
      privatePayment_.WriteTo(ref output, _repeated_privatePayment_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 34: {
            reissues_.AddEntriesFrom(ref input, _repeated_reissues_codec);
            break;
          }
          case 42: {
            burns_.AddEntriesFrom(ref input, _repeated_burns_codec);
            break;
          }
          case 50: {
            if (errorMessage_ == null) {
          ...
          case 58: {
            sponsorFees_.AddEntriesFrom(ref input, _repeated_sponsorFees_codec);
            break;
          }
          case 66: {
          ...
          case 74: {
            leaseCancels_.AddEntriesFrom(ref input, _repeated_leaseCancels_codec);
            break;
          }
          case 82: {
          ...
          case 90: {
            privatePayment_.AddEntriesFrom(ref input, _repeated_privatePayment_codec);
            break;
          }
        }
      }
    ...
    public static partial class Types {
      ...
      #endif
      {
        ...
        void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
          ...
          argsBytes_.WriteTo(ref output, _repeated_argsBytes_codec);
        ...
        void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
          ...
          while ((tag = input.ReadTag()) != 0) {
            switch(tag) {
              ...
              case 18: {
                argsBytes_.AddEntriesFrom(ref input, _repeated_argsBytes_codec);
                break;
              }
              case 26: {
