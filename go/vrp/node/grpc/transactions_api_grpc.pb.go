...
type TransactionsApiClient interface {
	...
	Sign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*vrp.SignedTransaction, error)
	Broadcast(ctx context.Context, in *vrp.SignedTransaction, opts ...grpc.CallOption) (*vrp.SignedTransaction, error)
}
...
func (c *transactionsApiClient) GetTransactions(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (TransactionsApi_GetTransactionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[0], "/vrp.node.grpc.TransactionsApi/GetTransactions", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetStateChanges(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (TransactionsApi_GetStateChangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[1], "/vrp.node.grpc.TransactionsApi/GetStateChanges", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetStatuses(ctx context.Context, in *TransactionsByIdRequest, opts ...grpc.CallOption) (TransactionsApi_GetStatusesClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[2], "/vrp.node.grpc.TransactionsApi/GetStatuses", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetUnconfirmed(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (TransactionsApi_GetUnconfirmedClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[3], "/vrp.node.grpc.TransactionsApi/GetUnconfirmed", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) Sign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*vrp.SignedTransaction, error) {
	out := new(vrp.SignedTransaction)
	err := c.cc.Invoke(ctx, "/vrp.node.grpc.TransactionsApi/Sign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionsApiClient) Broadcast(ctx context.Context, in *vrp.SignedTransaction, opts ...grpc.CallOption) (*vrp.SignedTransaction, error) {
	out := new(vrp.SignedTransaction)
	err := c.cc.Invoke(ctx, "/vrp.node.grpc.TransactionsApi/Broadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransactionsApiServer interface {
	...
	Sign(context.Context, *SignRequest) (*vrp.SignedTransaction, error)
	Broadcast(context.Context, *vrp.SignedTransaction) (*vrp.SignedTransaction, error)
...
func (UnimplementedTransactionsApiServer) Sign(context.Context, *SignRequest) (*vrp.SignedTransaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sign not implemented")
}
func (UnimplementedTransactionsApiServer) Broadcast(context.Context, *vrp.SignedTransaction) (*vrp.SignedTransaction, error) {
...
func _TransactionsApi_Sign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vrp.node.grpc.TransactionsApi/Sign",
	}
...
func _TransactionsApi_Broadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vrp.node.grpc.TransactionsApi/Broadcast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionsApiServer).Broadcast(ctx, req.(*vrp.SignedTransaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransactionsApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "vrp.node.grpc.TransactionsApi",
	...
	Metadata: "vrp/node/grpc/transactions_api.proto",
}
