...
func (c *blocksApiClient) GetBlock(ctx context.Context, in *BlockRequest, opts ...grpc.CallOption) (*BlockWithHeight, error) {
	...
	err := c.cc.Invoke(ctx, "/vrp.node.grpc.BlocksApi/GetBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blocksApiClient) GetBlockRange(ctx context.Context, in *BlockRangeRequest, opts ...grpc.CallOption) (BlocksApi_GetBlockRangeClient, error) {
	stream, err := c.cc.NewStream(ctx, &BlocksApi_ServiceDesc.Streams[0], "/vrp.node.grpc.BlocksApi/GetBlockRange", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *blocksApiClient) GetCurrentHeight(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*wrappers.UInt32Value, error) {
	...
	err := c.cc.Invoke(ctx, "/vrp.node.grpc.BlocksApi/GetCurrentHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedBlocksApiServer
...
// UnimplementedBlocksApiServer must be embedded to have forward compatible implementations.
...
func (UnimplementedBlocksApiServer) mustEmbedUnimplementedBlocksApiServer() {}
...
func _BlocksApi_GetBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vrp.node.grpc.BlocksApi/GetBlock",
	}
...
func _BlocksApi_GetCurrentHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vrp.node.grpc.BlocksApi/GetCurrentHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BlocksApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "vrp.node.grpc.BlocksApi",
	...
	Metadata: "vrp/node/grpc/blocks_api.proto",
}
